...
class ArkModDownloader():
    ...
    def download_mod(self, modid):
        ...
        subprocess.call(self.steamcmd + " +login anonymous" + " +workshop_download_item" + " 346110" + " " + modid + " +quit", shell=True)
    ...
    def create_mod_file(self, modid):
        ...
        with open(os.path.join(self.temp_mod_path, modid, r"WindowsNoEditor/" + modid + ".mod"), "w+b") as f:
            ...
            os.rename(self.temp_mod_path + "/" + str(modid) + "/WindowsNoEditor/" + str(modid) + ".mod", "ShooterGame/Content/Mods/" + str(modid) + ".mod")
        return True
